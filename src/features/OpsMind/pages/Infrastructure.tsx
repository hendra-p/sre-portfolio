    ...
    <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
        ...
        <div className="flex gap-3 w-full sm:w-auto">
          <button className="flex-1 sm:flex-initial px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-sm font-bold hover:bg-white/10 transition-all">Filter</button>
          <button className="flex-1 sm:flex-initial px-4 py-2 bg-primary text-background rounded-lg text-sm font-bold hover:bg-primary/90 transition-all">+ Add Node</button>
        </div>
      </div>
